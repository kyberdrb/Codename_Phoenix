...
* link:https://www.instagram.com/tv/B99CefzAbdl/[Redefining Productivity - Sonya Renee Taylor]
...
* SDE - Self-Directed Education
  ** *What is education?*
    *** *[Education is] everything that a person learns that enables that person to live a meaningful and satisfying life.* +
    link:https://soundcloud.com/greatergoodsojai/peter-gray[peter gray - 4:18-4:36]
...
* Self-Directed Executive Functioning: Advice for getting started with tasks with more ease
11:38-16:22
https://www.youtube.com/watch?v=0RTwK-9p404&feature=youtu.be&t=698
