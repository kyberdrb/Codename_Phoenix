...
The needs is the reason, why I'm feeling the way I feeling.
...
* disturbed / gestört / vyrušený, znepokojený (rušiť, vyrušiť, znepokojiť)
...
optimal human performance = happiness
...
link:...[Flow - Mihály Csíkszentmihályi]
...
* encouraged /
* hopeful /
* gut (vague feeling - needs to be more closely specified in order to make a closer connection) /
...
* https://www.youtube.com/watch?v=bH9t1lAX2UQ Training Session # 2 Marshall Rosenberg CNVC org - 58:10-1:07:00
