...
* link:https://www.youtube.com/watch?v=bH9t1lAX2UQ[Training Session # 2 Marshall Rosenberg CNVC org]
  ...
  ** 58:10-1:07:15 https://www.youtube.com/watch?v=bH9t1lAX2UQ&feature=youtu.be&t=3490
    ...
    *We're thinking that our safety depends on how other people might respond to us.* +
    ...
    How we can take it personally and feel shame. +
...
I can alter my internal environment through *gratitude*.
...
* IBS: Irritable Bowel Syndrome [for the lack of a better name]
* Belching
* Flatulence
* Heartburn
* Stomach pain
...
Feeling is also an information. Not only a fact is an information. +
Gefühl ist auch eine Information. Nicht nur ein fakt ist eine Information. +
Pocit je tiež informácia. Nie len fakt je informácia.
